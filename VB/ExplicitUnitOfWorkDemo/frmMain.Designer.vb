...
#End Region
        ...
        Private btnRecreateAddress As DevExpress.XtraEditors.SimpleButton
        ...
        Private btnCreatePerson As DevExpress.XtraEditors.SimpleButton

        Private unitOfWork1 As DevExpress.Xpo.UnitOfWork

        Private btnCreatePersons As DevExpress.XtraEditors.SimpleButton

        Private btnUpdate As DevExpress.XtraEditors.SimpleButton

        Private spinEdit1 As DevExpress.XtraEditors.SpinEdit

        Private labelControl1 As DevExpress.XtraEditors.LabelControl

        Private btnClearDB As DevExpress.XtraEditors.SimpleButton
    End Class
End Namespace
