	...
	Partial Public Class frmMain
		...
		Private Sub InitializeComponent()
			...
			Me.xpView1.Properties.AddRange(New DevExpress.Xpo.ViewProperty() {
				...
				New DevExpress.Xpo.ViewProperty("Address", DevExpress.Xpo.SortDirection.None, "ToStr([Address.Oid]) + ': ' + [Address.Country] + ', ' + [Address.Province] + ', " & "' + [Address.City] + ', ' + [Address.Address1] + ', ' + [Address.Address2]", False, True)
			})
...
'ORIGINAL LINE: this.btnRecreateAddress.Click += new System.EventHandler(this.btnRecreateAddress_Click);
			' 
			' btnCreatePerson
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnCreatePerson.Click += new System.EventHandler(this.btnCreatePerson_Click);
			' 
			' btnCreatePersons
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnCreatePersons.Click += new System.EventHandler(this.btnCreatePersons_Click);
			' 
			' btnUpdate
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnUpdate.Click += new System.EventHandler(this.btnUpdate_Click);
			' 
			' spinEdit1
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.btnClearDB.Click += new System.EventHandler(this.btnClearDB_Click);
			' 
			' Form1
			' 
